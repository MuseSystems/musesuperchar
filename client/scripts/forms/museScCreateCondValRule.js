...
this.MuseSuperChar.CreateCondValRule = this.MuseSuperChar.CreateCondValRule || {};
...
(function(pPublicApi, pGlobal) {
    ...
    var ifValidatorTypeComboBox = mywindow.findChild("ifValidatorTypeComboBox");
    ...
    var thenDataTypeFormLayout = mywindow.findChild("thenDataTypeFormLayout");
    var thenDataTypeValueXLabel = mywindow.findChild("thenDataTypeValueXLabel");
    ...
    var thenValidatorTypeComboBox = mywindow.findChild("thenValidatorTypeComboBox");
    var thenValidatorTypeXLabel = mywindow.findChild("thenValidatorTypeXLabel");
    ...
    var isConValRuleValid = function() {
        return MuseUtils.isValidId(ifSuperCharComboBox.id()) &&
    ...
    var getValidatorValuesStructure = function(pPrefix, pValTypeIntName, 
        ...
        case "dategreaterthanorequalto":
            ...
            try {
                data[testValName] = MuseSuperChar.Widget.generateScWidget(
                        pSuperChar.scdef_datatype_internal_name, testValName);

                if(data[testValName].hasOwnProperty("editingFinished()")) {
                    data[testValName].MSSC.pushValidationFunction(function() {
                        if(MuseUtils.coalesce(data[testValName].text,"") === "") {
                    ...
                    data[testValName].MSSC.pushValidationFunction(function() {
                        if(MuseUtils.coalesce(data[testValName].date,"") === "") {
                            return "You must provide a test value for " + pPrefix +
                                " condition " + pValTypeDispName + ".";
                        } else {
                            return null;
                    ...
                    data[testValName]["newDate(QDate)"].connect(setButtons);
                }
        ...
        case "datebetweeninclusive":
            ...
            try {
                data[lowValName] = MuseSuperChar.Widget.generateScWidget(
                        pSuperChar.scdef_datatype_internal_name, lowValName);
                data[highValName] = MuseSuperChar.Widget.generateScWidget(
                        pSuperChar.scdef_datatype_internal_name, highValName);

                if(pValTypeIntName == "numericbetweeninclusive") {
                    data[lowValName].MSSC.pushValidationFunction(function() {
                    ...
                    data[highValName].MSSC.pushValidationFunction(function() {
                    ...
                    data[lowValName]["newDate(QDate)"].connect(setButtons);
                    data[highValName]["newDate(QDate)"].connect(setButtons);
                }
            } catch(e) {
                throw new MuseUtils.ApiException(
                    "musesuperchar",
    ...
    var addValidatorWidget = function(pPrefix, pValTypeComboBox, 
        ...
        if(['flagistrue', 'flagisfalse'].includes(pValTypeComboBox.code)) {
            ...
            var widgetData = getValidatorValuesStructure(pPrefix,
    ...
    var populateThenScDependents = function () {
        if(MuseUtils.isValidId(thenSuperCharComboBox.id())) {
            ...
            thenDataTypeValueXLabel.text = subSc.scdef_datatype_display_name;
            try {
        ...
        if(MuseUtils.isValidId(ifSuperCharComboBox.id())) {
            ...
            try {
                ifValidatorTypeComboBox.populate(
                    MuseSuperChar.SuperChar.getValidatorTypesForSuperChar(
                        objSc.scdef_id));
                ifValidatorTypeComboBox.setId(currCondValRule.condvalrule_if_valtype_id);
    ...
    var save = function() {
        ...
        try {
            ...
            case "regexp":
                ...
                break;
            case "numericequal":
                validatorData.condvalrule_ifval_numeric =
            ...
            case "numericgreaterthan":
            case "numericgreaterthanorequalto":
                validatorData.condvalrule_ifval_numeric_lower =
                    MuseSuperChar.Data.Entities.if_condvalrule.scdefs.if_test_val.getNumericValue();
                break;
            case "dateequal":
            ...
            case "numericbetweeninclusive":
                validatorData.condvalrule_ifval_numeric_lower =
                    MuseSuperChar.Data.Entities.if_condvalrule.scdefs.if_low_val.getNumericValue();
                validatorData.condvalrule_ifval_numeric_upper =
            ...
            case "regexp":
                ...
                break;
            case "numericequal":
                validatorData.condvalrule_thenval_numeric =
            ...
            case "numericgreaterthan":
            case "numericgreaterthanorequalto":
                validatorData.condvalrule_thenval_numeric_lower =
                    MuseSuperChar.Data.Entities.then_condvalrule.scdefs.then_test_val.getNumericValue();
                break;
            case "dateequal":
            ...
            case "numericbetweeninclusive":
                validatorData.condvalrule_thenval_numeric_lower =
                    MuseSuperChar.Data.Entities.then_condvalrule.scdefs.then_low_val.getNumericValue();
                validatorData.condvalrule_thenval_numeric_upper =
    ...
    pPublicApi.sThenSuperCharSelected = function(pI) {
        try {
            populateThenScDependents();
        } catch(e) {
            MuseUtils.displayError(e, mywindow);
    ...
    pPublicApi.set = function(pParams) {
        ...
        setButtons();
        var parsedParams = MuseUtils.parseParams(pParams);
