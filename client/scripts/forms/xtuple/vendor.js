...
try {
    ...
    if (typeof MuseSuperChar.Vendor === "undefined") {
        MuseSuperChar.Vendor = {};
    }
    ...
    if (
        ...
        var error = new MuseUtils.ScriptException(
            "musesuperchar",
            "We encountered a script level issue while processing MuseSuperChar.Vendor.",
            "MuseSuperChar.Vendor",
            { thrownError: e },
            MuseUtils.LOG_FATAL
        );
        ...
        QMessageBox.critical(
            mainwindow,
            "MuseSuperChar.Vendor Script Error",
            "We encountered a script level issue while processing MuseSuperChar.Vendor."
        );
    }
}
...
(function(pPublicApi, pGlobal) {
    try {
        ...
        var XTP_CHAR_TAB = "characteristicsTab";
        var ENTITY_DATA_TABLE = "public_vendinfo";
     ...
     */
        ...
        var error = new MuseUtils.ModuleException(
            "musesuperchar",
            "We enountered a MuseSuperChar.Vendor module error that wasn't otherwise caught and handled.",
            "MuseSuperChar.Vendor",
            { thrownError: e },
            MuseUtils.LOG_FATAL
        );
