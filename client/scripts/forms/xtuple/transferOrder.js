...
try {
    ...
    if (typeof MuseSuperChar.TransferOrder === "undefined") {
        MuseSuperChar.TransferOrder = {};
    }
    ...
    if (
        ...
        var error = new MuseUtils.ScriptException(
            "musesuperchar",
            "We encountered a script level issue while processing MuseSuperChar.TransferOrder.",
            "MuseSuperChar.TransferOrder",
            { thrownError: e },
            MuseUtils.LOG_FATAL
        );
        ...
        QMessageBox.critical(
            mainwindow,
            "MuseSuperChar.TransferOrder Script Error",
            "We encountered a script level issue while processing MuseSuperChar.TransferOrder."
        );
    }
}
...
(function(pPublicApi, pGlobal) {
    try {
        ...
        var XTP_CHAR_TAB = "_documentsPage";
        var ENTITY_DATA_TABLE = "public_tohead";
        ...
        var mySave = function(pRecId) {
            ...
            try {
                ...
                var error = new MuseUtils.FormException(
                    ...
                    "MuseSuperChar.TransferOrder.mySave",
        ...
        var error = new MuseUtils.ModuleException(
            "musesuperchar",
            "We enountered a MuseSuperChar.TransferOrder module error that wasn't otherwise caught and handled.",
            "MuseSuperChar.TransferOrder",
            { thrownError: e },
            MuseUtils.LOG_FATAL
        );
...
})(MuseSuperChar.TransferOrder, this);
