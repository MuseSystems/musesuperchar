...
try {
    ...
    if (typeof MuseSuperChar.Data.Entities === "undefined") {
        MuseSuperChar.Data.Entities = {};
    }
    ...
    if (
        ...
        var error = new MuseUtils.ScriptException(
            "musesuperchar",
            "We encountered a script level issue while processing MuseSuperChar.Widget.",
            "MuseSuperChar.Widget",
            { thrownError: e },
            MuseUtils.LOG_FATAL
        );
        ...
        QMessageBox.critical(
            mainwindow,
            "MuseSuperChar.Widget Script Error",
            "We encountered a script level issue while processing MuseSuperChar.Widget."
        );
    }
}
...
(function(pPublicApi, pGlobal) {
    try {
            ...
            try {
                ...
                for (var i_col = pColumns.length - 1; i_col >= 0; i_col--) {
                    ...
                    for (var i_dat = 0; i_dat < currColData.length; i_dat++) {
                        ...
                        currDatLabel.text =
                            currColData[i_dat].scdef_display_name;
            ...
            try {
                ...
                layoutSections.sort(function(a, b) {
                    if (a.section_column_count > b.section_column_count) {
                        ...
                        a.section_column_count < b.section_column_count
                    ) {
                        return 1;
                ...
                for (var i_sec = 0; i_sec < layoutSections.length; i_sec++) {
                    ...
                    if (seenSections.includes(curSecName)) {
                        ...
                        var curHBoxLayout = new QBoxLayout(
                        ...
                        for (
                            ...
                            var curSubSecName =
                                layoutSections[i_sub].section_name;
            ...
            try {
                ...
                for (var i1 = 0; i1 < layoutSections.length; i1++) {
                    if (
                        ...
                        maxColumnCount =
                            layoutSections[i1].section_column_count;
                    }
                }
        ...
        var returnValidatorExceptions = function(pScDefs) {
            ...
            for (var currSc in pScDefs) {
                if (
                    ...
                    if (currResult !== null) {
                        returnValExcept =
                            MuseUtils.coalesce(returnValExcept, "") +
                            currResult;
                    }
                }
            }
        ...
        var returnAllValidatorExceptions = function() {
            ...
            for (var currEntity in MuseSuperChar.Data.Entities) {
                if (
                    ...
                    MuseSuperChar.Data.Entities[currEntity].hasOwnProperty(
                        "scdefs"
                    )
                ) {
        ...
        var generateWidget = function(pStructure) {
            ...
            var composedWidgetVBoxLayout = new QBoxLayout(
            ...
            for (var i_row = 0; i_row < rows.length; i_row++) {
                var currGrpRowHBoxLayout = new QBoxLayout(
                    QBoxLayout.LeftToRight
                );
                ...
                for (var i_sec = 0; i_sec < currRow.length; i_sec++) {
                    ...
                    var sectionHBoxLayout = new QBoxLayout(
                        QBoxLayout.LeftToRight
                    );
                    sectionHBoxLayout.objectName =
                        currRow[i_sec].section_internal_name;
        ...
        pPublicApi.generateScWidget = function(
            pDataTypeIntName,
            pScInternalName
        ) {
            // Capture function parameters for later exception references.
        ...
        var error = new MuseUtils.ModuleException(
            "musesuperchar",
            "We enountered a MuseSuperChar.Widget module error that wasn't otherwise caught and handled.",
            "MuseSuperChar.Widget",
            { thrownError: e },
            MuseUtils.LOG_FATAL
        );
