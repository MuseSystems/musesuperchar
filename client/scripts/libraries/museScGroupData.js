...
(function(pPublicApi) {
    ...
    var getGroupLayoutItems = function(pParams) {
        ...
        if(pParams.hasOwnProperty("scdef_scgrp_ass_section_name") && 
        ...
        try {
            return MuseUtils.executeQuery(
                ...
                whereClause +
                "ORDER BY scdef_scgrp_ass_sequence ", pParams);
        } catch(e) {
            throw new MuseUtils.DatabaseException(
                "musesuperchar",
    ...
    var createGroupLayoutItem = function(pGroupLayoutData) {
        ...
        if(pGroupLayoutData.hasOwnProperty("scdef_scgrp_ass_section_name") &&
            MuseUtils.coalesce(
        ...
        if(pGroupLayoutData.hasOwnProperty("scdef_scgrp_ass_is_column_start") &&
            MuseUtils.realNull(
                pGroupLayoutData.scdef_scgrp_ass_is_column_start) !== null) {
            columnList.push("scdef_scgrp_ass_is_column_start");
            valueList.push('<? value("scdef_scgrp_ass_is_column_start") ?>');
        }
    ...
    var updateGroupLayoutItem = function(pGroupLayoutData) {
        ...
        if(pGroupLayoutData.hasOwnProperty("scdef_scgrp_ass_section_name")) {
            queryText += ',scdef_scgrp_ass_section_name = ' +
                '<? value("scdef_scgrp_ass_section_name") ?> ';
        }

        if(pGroupLayoutData.hasOwnProperty("scdef_scgrp_ass_is_column_start")) {
            queryText += ',scdef_scgrp_ass_is_column_start = ' +
        ...
        if(pGroupLayoutData.hasOwnProperty("scdef_scgrp_ass_width") &&
            Number.isInteger(pGroupLayoutData.scdef_scgrp_ass_width) &&
            pGroupLayoutData.scdef_scgrp_ass_width > 0) {
            queryText += ',scdef_scgrp_ass_width = ' +
                '<? value("scdef_scgrp_ass_width") ?> ';
        } else if(pGroupLayoutData.hasOwnProperty("scdef_scgrp_ass_width") &&
            Number.isInteger(pGroupLayoutData.scdef_scgrp_ass_width) &&
        ...
        if(pGroupLayoutData.hasOwnProperty("scdef_scgrp_ass_height") &&
            Number.isInteger(pGroupLayoutData.scdef_scgrp_ass_height) &&
            pGroupLayoutData.scdef_scgrp_ass_height > 0) {
            queryText += ',scdef_scgrp_ass_height = ' +
                '<? value("scdef_scgrp_ass_height") ?> ';
        } else if(pGroupLayoutData.hasOwnProperty("scdef_scgrp_ass_height") &&
            Number.isInteger(pGroupLayoutData.scdef_scgrp_ass_height) &&
        ...
        queryText += 'WHERE scdef_scgrp_ass_id = ' +
            '<? value("scdef_scgrp_ass_id") ?> ' +
            'RETURNING scdef_scgrp_ass_id';

        try {
            var gliQry = MuseUtils.executeQuery(queryText, pGroupLayoutData);
    ...
    pPublicApi.isGroupLayoutItemSystemLocked = function(pGroupLayoutItemId) {
        // Capture function parameters for later exception references.
        var funcParams = {
            pGroupLayoutItemId: pGroupLayoutItemId
        };
    ...
    pPublicApi.createGroupLayoutItem = function(pGroupLayoutData) {
        ...
        if(!pGroupLayoutData.hasOwnProperty("scdef_scgrp_ass_scdef_id") ||
        ...
        if(!pGroupLayoutData.hasOwnProperty("scdef_scgrp_ass_scgrp_id") ||
    ...
    pPublicApi.updateGroupLayoutItem = function(pGroupLayoutData) {
        ...
        if(!pGroupLayoutData.hasOwnProperty("scdef_scgrp_ass_id") ||
