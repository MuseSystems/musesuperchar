...
this.MuseSuperChar.CondValRule = this.MuseSuperChar.CondValRule || {};
...
(function(pPublicApi) {
    ...
    var getValidators = function(pParams) {
        ...
        if(pParams.hasOwnProperty("condvalrule_subject_scdef_id")) {
            whereClause += "AND condvalrule_subject_scdef_id = " +
                '<? value("condvalrule_subject_scdef_id") ?> ';
        }

        if(pParams.hasOwnProperty("condvalrule_object_scdef_id")) {
            whereClause += "AND condvalrule_object_scdef_id = " +
                '<? value("condvalrule_object_scdef_id") ?> ';
        }

        if(pParams.hasOwnProperty("condvalrule_object_scdef_display_name")) {
            whereClause += "AND sd.scdef_display_name = " +
                '<? value("condvalrule_object_scdef_display_name") ?> ';
        }

        if(pParams.hasOwnProperty("condvalrule_object_scdef_internal_name")) {
            whereClause += "AND sd.scdef_internal_name = " +
    ...
    var upsertValidator = function(pValidatorData) {
        ...
        try {
            ...
            if(pValidatorData.hasOwnProperty(
                ...
                thenValType = 
                    getValTypeById(pValidatorData.condvalrule_then_valtype_id);
            }
        } catch(e) {
            throw new MuseUtils.DatabaseException(
                "musesuperchar",
        ...
        case pPublicApi.NUMERICEQUAL:
            ...
            valuesList.push('numrange(<? value("condvalrule_ifval_numeric") ?>, <? value("condvalrule_ifval_numeric") ?>,$$[]$$)');
            break;
        case pPublicApi.NUMERICLESSTHAN:
            columnsList.push("condvalrule_ifval_numrange");
            valuesList.push('numrange(null, <? value("condvalrule_ifval_numeric_upper") ?>, $$[)$$)');
            break;
        ...
        case pPublicApi.NUMERICGREATERTHAN:
            columnsList.push("condvalrule_ifval_numrange");
            valuesList.push('numrange(<? value("condvalrule_ifval_numeric_lower") ?>, null, $$(]$$)');
            break;
        ...
        case pPublicApi.NUMERICBETWEENINCLUSIVE:
            columnsList.push("condvalrule_ifval_numrange");
            valuesList.push('numrange(<? value("condvalrule_ifval_numeric_lower") ?>, <? value("condvalrule_ifval_numeric_upper") ?>, $$[]$$)');
            break;
        case pPublicApi.DATEEQUAL:
            columnsList.push("condvalrule_ifval_daterange");
            valuesList.push('daterange((<? value("condvalrule_ifval_date") ?>)::date, <? (value("condvalrule_ifval_date"))::date ?>,$$[]$$)');
            break;
        case pPublicApi.DATELESSTHAN:
            columnsList.push("condvalrule_ifval_daterange");
            valuesList.push('daterange(null, (<? value("condvalrule_ifval_date_upper") ?>)::date, $$[)$$)');
            break;
        ...
        case pPublicApi.DATEGREATERTHAN:
            columnsList.push("condvalrule_ifval_daterange");
            valuesList.push('daterange((<? value("condvalrule_ifval_date_lower") ?>)::date, null, $$(]$$)');
            break;
        ...
        case pPublicApi.DATEBETWEENINCLUSIVE:
            columnsList.push("condvalrule_ifval_daterange");
            valuesList.push('daterange((<? value("condvalrule_ifval_date_lower") ?>)::date, (<? value("condvalrule_ifval_date_upper") ?>)::date, $$[]$$)');
            break;
        default:
        ...
        case pPublicApi.REGEXP:
            ...
            valuesList.push('<? value("condvalrule_thenval_regexp") ?>');
            break;
        case pPublicApi.NUMERICEQUAL:
            columnsList.push("condvalrule_thenval_numrange");
            valuesList.push('numrange(<? value("condvalrule_thenval_numeric") ?>, <? value("condvalrule_thenval_numeric") ?>,$$[]$$)');
            break;
        case pPublicApi.NUMERICLESSTHAN:
            columnsList.push("condvalrule_thenval_numrange");
            valuesList.push('numrange(null, <? value("condvalrule_thenval_numeric_upper") ?>, $$[)$$)');
            break;
        case pPublicApi.NUMERICLESSTHANOREQUALTO:
            columnsList.push("condvalrule_thenval_numrange");
            valuesList.push('numrange(null, <? value("condvalrule_thenval_numeric_upper") ?>, $$[]$$)');
        ...
        case pPublicApi.NUMERICGREATERTHAN:
            columnsList.push("condvalrule_thenval_numrange");
            valuesList.push('numrange(<? value("condvalrule_thenval_numeric_lower") ?>, null, $$(]$$)');
            break;
        case pPublicApi.NUMERICGREATERTHANOREQUALTO:
            columnsList.push("condvalrule_thenval_numrange");
            valuesList.push('numrange(<? value("condvalrule_thenval_numeric_lower") ?>, null, $$[]$$)');
        ...
        case pPublicApi.NUMERICBETWEENINCLUSIVE:
            columnsList.push("condvalrule_thenval_numrange");
            valuesList.push('numeric(<? value("condvalrule_thenval_numeric_lower") ?>, <? value("condvalrule_thenval_numeric_upper") ?>, $$[]$$)');
            break;
        case pPublicApi.DATEEQUAL:
            columnsList.push("condvalrule_thenval_daterange");
            valuesList.push('daterange((<? value("condvalrule_thenval_date") ?>)::date, <? (value("condvalrule_thenval_date"))::date ?>,$$[]$$)');
            break;
        case pPublicApi.DATELESSTHAN:
            columnsList.push("condvalrule_thenval_daterange");
            valuesList.push('daterange(null, (<? value("condvalrule_thenval_date_upper") ?>)::date, $$[)$$)');
            break;
        case pPublicApi.DATELESSTHANOREQUALTO:
            columnsList.push("condvalrule_thenval_daterange");
            valuesList.push('daterange(null, (<? value("condvalrule_thenval_date_upper") ?>)::date, $$[]$$)');
        ...
        case pPublicApi.DATEGREATERTHAN:
            columnsList.push("condvalrule_thenval_daterange");
            valuesList.push('daterange((<? value("condvalrule_thenval_date_lower") ?>)::date, null, $$(]$$)');
            break;
        case pPublicApi.DATEGREATERTHANOREQUALTO:
            columnsList.push("condvalrule_thenval_daterange");
            valuesList.push('daterange((<? value("condvalrule_thenval_date_lower") ?>)::date, null, $$[]$$)');
        ...
        case pPublicApi.DATEBETWEENINCLUSIVE:
            columnsList.push("condvalrule_thenval_daterange");
            valuesList.push('daterange((<? value("condvalrule_thenval_date_lower") ?>)::date, (<? value("condvalrule_thenval_date_upper") ?>)::date, $$[]$$)');
            break;
        default:
            // We do have cases where a type has no additional value so an empty
            // default is completely reasonable.
        ...
        if(pValidatorData.hasOwnProperty("condvalrule_id") &&
            ...
            queryString = "INSERT INTO musesuperchar.condvalrule (" + 
                columnsList.join(",") + 
        ...
        try {
            var cvrQry = MuseUtils.executeQuery(queryString, pValidatorData);
    ...
    pPublicApi.createValidator = function(pValidatorData) {
        ...
        if(!pValidatorData.hasOwnProperty("condvalrule_subject_scdef_id") ||
            !MuseUtils.isValidId(pValidatorData.condvalrule_subject_scdef_id)) {
            throw new MuseUtils.ParameterException(
                "musesuperchar",
        ...
        if(!pValidatorData.hasOwnProperty("condvalrule_object_scdef_id") ||
        ...
        if((!pValidatorData.hasOwnProperty("condvalrule_if_valtype_id") ||
            !MuseUtils.isValidId(pValidatorData.condvalrule_if_valtype_id)) &&
            (!pValidatorData.hasOwnProperty("condvalrule_if_valtype_internal_name") ||
                MuseUtils.coalesce(
                    pValidatorData.condvalrule_if_valtype_internal_name, "") === ""))  {
            throw new MuseUtils.ParameterException(
                "musesuperchar",
        ...
        if((!pValidatorData.hasOwnProperty("condvalrule_then_valtype_id") ||
            !MuseUtils.isValidId(pValidatorData.condvalrule_then_valtype_id)) &&
            (!pValidatorData.hasOwnProperty("condvalrule_then_valtype_internal_name") ||
                MuseUtils.coalesce(
                    pValidatorData.condvalrule_then_valtype_internal_name, "") === "")) {
            throw new MuseUtils.ParameterException(
                "musesuperchar",
        ...
        if(!pValidatorData.hasOwnProperty("condvalrule_fails_message_text") ||
            MuseUtils.coalesce(
...
})(this.MuseSuperChar.CondValRule);
